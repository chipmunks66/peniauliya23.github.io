                ...
                <div class="tm-col-left">
                    <div class="tm-site-header media">
                        ...
                        <div class="media-body">
                            <h1 class="tm-sitename text-uppercase">peni auliya</h1>
                            <p class="tm-slogon">perempuan apa ada nya</p>
                        </div>        
                    </div>
                </div>
                        ...
                        <div class="collapse navbar-collapse tm-nav" id="navbar-nav">
                            <ul class="navbar-nav text-uppercase">
                                <li class="nav-item active">
                                    <a class="nav-link tm-nav-link" href="#">peni auliya <span class="sr-only">(current)</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link tm-nav-link" href="about.html">About peni auliya</a>                            
                                </li>
                                <li class="nav-item">
            ...
            <div class="tm-row">
                ...
                <main class="tm-col-right">
                    <section class="tm-content">
                        <h2 class="mb-5 tm-content-title">tentang peni auliya</h2>
                        <p class="mb-5">peni auliya. perempuan yang apa ada nya,.</p>
                        <hr class="mb-5">
